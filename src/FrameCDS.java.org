...
public class FrameCDS extends JFrame{
	...
	private JTabbedPane jTabbedPane_jPanel_bottom_1;
	private JTabbedPane jTabbedPane_jPanel_bottom_2;
	private JTabbedPane jTabbedPane_jPanel_bottom_3;
	private JTabbedPane jTabbedPane_jPanel_bottom_4;
	private JPanel jPanel_bottom_1;
	private JPanel jPanel_bottom_2;
	private JPanel jPanel_bottom_3;
	private JPanel jPanel_bottom_4;
...
//		  jContentPane.setPreferredSize(new Dimension(1000, 700));
		  jContentPane.setPreferredSize(new Dimension(1550, 850));

		  jContentPane.add(getJToolBar(), null);
		  
		  jContentPane.add(getJTabbedPane_left(), null);
	...
	private JButton getJButton_loadData() {
		if (jButton_loadData == null) {
			...
			jButton_loadData.setIcon(new ImageIcon(getClass().getResource("/images/load.png")));
...
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
	...
	private JButton getJButton_run() {
		if (jButton_run == null) {
			...
			jButton_run.setIcon(new ImageIcon(getClass().getResource("/images/start.png")));
...
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
	...
	private JButton getJButton_pause() {
		if (jButton_pause == null) {
			...
			jButton_pause.setIcon(new ImageIcon(getClass().getResource("/images/pause.png")));
...
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
	...
	private JButton getJButton_step() {
		if (jButton_step == null) {
			...
			jButton_step.setIcon(new ImageIcon(getClass().getResource("/images/step.png")));
...
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
	...
	private JButton getJButton_stop() {
		if (jButton_stop == null) {
			...
			jButton_stop.setIcon(new ImageIcon(getClass().getResource("/images/stop.png")));
...
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
	...
	private JTextField getJTextField() {
		if (jTextField == null) {
			...
			jTextField.setBounds(new Rectangle(222, 107, 62, 20));
			jTextField.setVisible(false);
			jTextField.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
//					System.out.println(e); // TODO Auto-generated Event stub actionPerformed()
					Parameters.OutsideEntityLoss = Double.valueOf(jTextField.getText());
				}
			});
	...
	private JTextField getJTextField1() {
		if (jTextField1 == null) {
			...
			jTextField1.setBounds(new Rectangle(204, 214, 76, 18));
			jTextField1.setVisible(false);
			jTextField1.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
					
					Parameters.percentageMBS = Double.valueOf(jTextField1.getText());
				}
			});
		}
		return jTextField1;
	...
	private JTextField getJTextField2() {
		if (jTextField2 == null) {
			...
			jTextField2.setBounds(new Rectangle(227, 278, 57, 20));
	...
	private JCheckBox getJCheckBox() {
		if (jCheckBox == null) {
			...
			jCheckBox.setBounds(new Rectangle(6, 300, 97, 20));
		}
		return jCheckBox;
	}
...
//			jTabbedPane_main.setBounds(new Rectangle(308, 40, 705, 508));//jPanel_networkjPanel_network.setSize(1024, 768);
			jTabbedPane_main.setBounds(new Rectangle(308, 40, 1024, 700));//jPanel_networkjPanel_network.setSize(1024, 768);
			jTabbedPane_main.setName("");
			jTabbedPane_main.setToolTipText("");
//			jTabbedPane_main.addTab("FDIC Data - Q1 2006", null, getJPanel_data(), null);
//			jTabbedPane_main.addTab("FDIC Data - Q4 2006", null, getJPanel_data(), null);
//			jTabbedPane_main.addTab("FDIC Data - Q3 2007", null, getJPanel_data(), null);
//			jTabbedPane_main.addTab("FDIC Data - Q4 2007", null, getJPanel_data(), null);
			jTabbedPane_main.addTab("FDIC Data - Q4 2008", null, getJPanel_data(), null);
...
//			jPanel_network.setSize(800, 850);
	...
	private JScrollPane getJScrollPane_data() {
		if (jScrollPane_data == null) {
			...
			jScrollPane_data.setBounds(new Rectangle(0, 0, 700, 480));
	...
	private JTable getJTable_data() {
		if (jTable_data == null) {
			...
			jTable_data.setBounds(new Rectangle(0, 0, 500, 470));
		}
		return jTable_data;
	}
	...
	private JComboBox getJComboBox_data() {
		if (jComboBox_data == null) {
			...
			jComboBox_data.setBounds(new Rectangle(103, 5, 170, 20));
			jComboBox_data.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					JComboBox cb = (JComboBox)e.getSource();
			        String param = (String)cb.getSelectedItem();
//					System.out.println(param); // TODO Auto-generated Event stub actionPerformed()
//			        if (param == "Q1 2006")
//			        if (param == "Q4 2006")
//			        if (param == "Q3 2007")
//			        if (param == "Q4 2007")
	...
	private JComboBox getJComboBox_banks() {
		if (jComboBox_banks == null) {
			jComboBox_banks = new JComboBox(DataController.getBanksNameShortAndInsuranceCompanies());
			this.jComboBox_banks.setSelectedIndex(0);
			jComboBox_banks.setBounds(new Rectangle(119, 50, 167, 20));
			jComboBox_banks.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
					JComboBox cb = (JComboBox)e.getSource();
			        String param = (String)cb.getSelectedItem();
					if (param == DataController.getBanksNameShortAndOutsideEntity()
							[DataController.getBanksNameShortAndOutsideEntity().length - 1])
			        {
					...
					else
					{
			        	...
			        	Parameters.DefaultingBank = cb.getSelectedIndex() + 1;
	...
	private JComboBox getJComboBox_exp() {
		if (jComboBox_exp == null) {
			...
			jComboBox_exp.setBounds(new Rectangle(89, 177, 196, 20));
			jComboBox_exp.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
					JComboBox cb = (JComboBox)e.getSource();
			        String param = (String)cb.getSelectedItem();
	...
	private JComboBox getJComboBox_net() {
		if (jComboBox_net == null) {
			...
			jComboBox_net.setBounds(new Rectangle(135, 241, 150, 20));
			jComboBox_net.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
					JComboBox cb = (JComboBox)e.getSource();
			        String param = (String)cb.getSelectedItem();
	...
	private void loadData_click ()
	{
		...
		jContentPane.add(getJTabbedPane_main(), null);
		jContentPane.add(getJTabbedPane_leftBottom(), null);
		jContentPane.add(getJPanel_bottom(), null);
...
//		this.jPanel_left.enableInputMethods(false);
		...
		jTabbedPane_left.addTab("Contagion", null, getJPanel_contagionLeft(), null);
		this.getJTabbedPane_left().addTab("Parameters", this.getJPanel_parameters());
...
//		this.treeCollapseDemo.setInitialNode(this.model.nodes.get(this.model.defaultBank ));
		...
		{
			this.graphContagion.setInitialNode(this.model.nodes.get(this.model.nodes.size() - 1));
		}
		else
		{
			this.graphContagion.setInitialNode(this.model.nodes.get(this.model.defaultBank ));
		}
...
//		this.jTabbedPane_left.getComponent(1).show();
		...
		this.jLabel_CC.setText(String.valueOf((double)((int)(cc * 100))/100));
		this.jLabel_CDS.setText(String.valueOf((double)((int)(cds * 100))/100));
...
//			jPanel_network.setLayout(new BoxLayout(getJPanel_network(), BoxLayout.X_AXIS));
			jPanel_network.setLayout(new BoxLayout(getJPanel_network(), BoxLayout.Y_AXIS));
//			jPanel_network.setLayout(new BorderLayout());
			jPanel_network.setSize(900, 950);
			jPanel_network.add(getGraphCDS(), null);
...
//			treeCollapseDemo.setBounds(new Rectangle(0, 0, 295, 315));
	...
	{
		if (showLayouts == null) {
			showLayouts = ShowLayouts.getGraphPanel(Network.getGraph(this.model.nodes,this.model.matrices.get(this.model.matrices.size() - 1)));
//			showLayouts.setBounds(new Rectangle(0, 0, 700, 477));//1024, 768
			showLayouts.setBounds(new Rectangle(0, 0, 1024, 768));//
		}
		return showLayouts;
	}
...
//		seriesCC = new TimeSeries("Core Capital", Long.class);
		TimeSeriesCollection datasetPrice = new TimeSeriesCollection(seriesCDSCover);
		
//		datasetPrice.addSeries(seriesCC);

		JFreeChart chart = ChartFactory.createTimeSeriesChart("Aggregate CDS Cover", "Order", "$bn", datasetPrice, false, true, false);
	  ...
	  private JFreeChart getChartCC() {
		...
		JFreeChart chart = ChartFactory.createTimeSeriesChart("Aggregate Core Capital", "Order", "$bn", datasetCC, false, true, false);
		chart.setBackgroundPaint(Color.white);
	  ...
	  private JFreeChart getChartInDegrees() {
		  ...
		  JFreeChart chart = ChartFactory.createBarChart("In Degrees",
				  "k in", "freq", dataset_indegrees, PlotOrientation.VERTICAL,
				  false, true, false);
	  ...
	  private JFreeChart getChartOutDegrees() {
		  ...
		  JFreeChart chart = ChartFactory.createBarChart("Out Degrees",
				  "k out", "freq", dataset_outdegrees, PlotOrientation.VERTICAL,
				  false, true, false);
	...
	private ChartPanel getJPanel_CDSCover() {
		if (jPanel_CDSCover == null) {
			...
			jPanel_CDSCover.setBounds(new Rectangle(0, 0, 500, 200));
		}
	...
	private ChartPanel getJPanel_CC() {
		if (jPanel_CC == null) {
			...
			jPanel_CC.setBounds(new Rectangle(0, 0, 500, 200));
		}
		return jPanel_CC;
	}
	...
	private ChartPanel getJPanel_inDegrees() {
		if (jPanel_inDegrees == null) {
			...
			jPanel_inDegrees.setBounds(new Rectangle(0, 0, 500, 200));
		}
	...
	private ChartPanel getJPanel_outDegrees() {
		if (jPanel_outDegrees == null) {
			...
			jPanel_outDegrees.setBounds(new Rectangle(0, 0, 500, 200));
		}
	...
	public void update ()
	{
		this.jLabel_simRound.setText(String.valueOf(Sim.getAbsoluteTime() + this.counter));
		if(this.model.getDBs() != null)  this.jLabel_numDB1.setText(String.valueOf(this.model.getDBs().length +
		...
		this.jLabel_INmean.setText(String.valueOf(this.model.getStatisticsIN().get(0)));
		this.jLabel_INstd.setText(String.valueOf(this.model.getStatisticsIN().get(2)));
		this.jLabel_INskew.setText(String.valueOf(this.model.getStatisticsIN().get(3)));
		this.jLabel_INkurt.setText(String.valueOf(this.model.getStatisticsIN().get(4)));
		this.jLabel_INconn.setText(String.valueOf(this.model.getStatisticsIN().get(5)));
		this.jLabel_INclust.setText(String.valueOf(this.model.getStatisticsIN().get(6)));
		
		this.jLabel_OUTmean.setText(String.valueOf(this.model.getStatisticsOUT().get(0)));
		this.jLabel_OUTstd.setText(String.valueOf(this.model.getStatisticsOUT().get(2)));
		this.jLabel_OUTskew.setText(String.valueOf(this.model.getStatisticsOUT().get(3)));
		this.jLabel_OUTkurt.setText(String.valueOf(this.model.getStatisticsOUT().get(4)));
		this.jLabel_OUTconn.setText(String.valueOf(this.model.getStatisticsOUT().get(5)));
		this.jLabel_OUTclust.setText(String.valueOf(this.model.getStatisticsOUT().get(6)));
...
//		else this.jLabel_numDB1.setText(String.valueOf(0));
	...
	public void updateCharts ()
	{
		...
		Date date = new Date(107, 05, 01, (int)Sim.getAbsoluteTime() + this.counter, 0, 0);
...
//		showLayouts = ShowLayouts.getGraphPanel(Network.getGraph(this.model.matrices.get(this.model.matrices.size() - 1)));
//		showLayouts.setBounds(new Rectangle(0, 0, 700, 477));
		
		
		
		this.graphCDS.update(this.model.nodes, this.model.matrices.get(this.model.matrices.size() - 1));
		
		this.jPanel_network.repaint();
		
//		this.treeCollapseDemo.updateTree(this.model.contagionList, this.model.nodes);
	...
	public void updateInDegrees ()
	{
		...
		{
			this.dataset_indegrees.addValue(this.model.inDegrees.get(i).value, "In Degrees", 
	...
	public void updateOutDegrees ()
	{
		...
		{
			this.dataset_outdegrees.addValue(this.model.outDegrees.get(i).value, "Out Degrees", 
	...
	private JTextField getJTextField3() {
		if (jTextField3 == null) {
			...
			jTextField3.setBounds(new Rectangle(242, 137, 42, 20));
			jTextField3.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
//					System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
					Parameters.percentageCC = Double.valueOf(jTextField3.getText());
				}
			});
		}
		return jTextField3;
	...
	private JPanel getJPanel_bottom() {
		if (jPanel_bottom == null) {
			...
			jPanel_bottom.setBounds(new Rectangle(5, 550, 1550, 290));
			jPanel_bottom.setBorder(BorderFactory.createLineBorder(SystemColor.activeCaption, 2));
			jTabbedPane_jPanel_bottom_1 = new JTabbedPane();
			jTabbedPane_jPanel_bottom_2 = new JTabbedPane();
			jTabbedPane_jPanel_bottom_3 = new JTabbedPane();
			jTabbedPane_jPanel_bottom_4 = new JTabbedPane();
			
			jPanel_bottom_1 = new JPanel();
			jPanel_bottom_2 = new JPanel();
			jPanel_bottom_3 = new JPanel();
			jPanel_bottom_4 = new JPanel();

			jPanel_bottom_1.add(getJPanel_bottom1(), BorderLayout.PAGE_START);
			jPanel_bottom_2.add(getJPanel_bottom2(), BorderLayout.PAGE_START);
			jPanel_bottom_3.add(getJPanel_bottom3(), BorderLayout.PAGE_START);
			jPanel_bottom_4.add(getJPanel_bottom4(), BorderLayout.PAGE_START);

			
//			jPanel_bottom_1.add(getJPanel_bottom1(), null);
//			jPanel_bottom_2.add(getJPanel_bottom2(), null);
//			jPanel_bottom_3.add(getJPanel_bottom3(), null);
//			jPanel_bottom_4.add(getJPanel_bottom4(), null);

			
			
//			jTabbedPane_main.addTab("Network", null, getJPanel_network(), null);
//			jTabbedPane_jPanel_bottom_1.add(jPanel_bottom_1, BorderLayout.LINE_START);
			jTabbedPane_jPanel_bottom_1.addTab("Tier 1 Capital", null, jPanel_bottom_1, null);
			jTabbedPane_jPanel_bottom_1.addTab("CDS Cover", null, jPanel_bottom_2, null);
			jTabbedPane_jPanel_bottom_1.addTab("In-Degrees", null, jPanel_bottom_3, null);
			jTabbedPane_jPanel_bottom_1.addTab("Out-Degrees", null, jPanel_bottom_4, null);
//			jTabbedPane_jPanel_bottom_2.add(jPanel_bottom_2, BorderLayout.LINE_START);
//			jTabbedPane_jPanel_bottom_3.add(jPanel_bottom_3, BorderLayout.LINE_START);
//			jTabbedPane_jPanel_bottom_4.add(jPanel_bottom_4, BorderLayout.LINE_START);

			
			
			jPanel_bottom.add(jTabbedPane_jPanel_bottom_1, null);
//			jPanel_bottom.add(jTabbedPane_jPanel_bottom_2, null);
//			jPanel_bottom.add(jTabbedPane_jPanel_bottom_3, null);
//			jPanel_bottom.add(jTabbedPane_jPanel_bottom_4, null);
			
//			jPanel_bottom.add(getJPanel_bottom1(), BorderLayout.LINE_START);
//			jPanel_bottom.add(getJPanel_bottom2(), BorderLayout.CENTER);
//			jPanel_bottom.add(getJPanel_bottom3(), BorderLayout.LINE_END);
//			jPanel_bottom.add(getJPanel_bottom4(), BorderLayout.PAGE_END);
		}
...
//			jPanel_bottom1.setBounds(new Rectangle(2, 2, 251, 161));
			jPanel_bottom1.setBounds(new Rectangle(2, 2, 190, 161));
...
//			jPanel_bottom2.setBounds(new Rectangle(253, 2, 251, 161));
			jPanel_bottom2.setBounds(new Rectangle(253, 2, 190, 161));
		}
...
//			jPanel_bottom3.setBounds(new Rectangle(504, 2, 251, 161));
			jPanel_bottom3.setBounds(new Rectangle(504, 2, 190, 161));
...
//			jPanel_bottom4.setBounds(new Rectangle(755, 2, 251, 161));
			jPanel_bottom4.setBounds(new Rectangle(755, 2, 190, 161));
	...
	private JTabbedPane getJTabbedPane_left() {
		if (jTabbedPane_left == null) {
			...
			jTabbedPane_left.setBounds(new Rectangle(5, 40, 300, 356));
			jTabbedPane_left.addTab("Parameters", null, getJPanel_parameters(), null);
//			jTabbedPane_left.addTab("Contagion", null, getJScrollPane_contagionLeft(), null);
		}
	...
	private JPanel getJPanel_parameters() {
		if (jPanel_parameters == null) {
			...
			jPanel_parameters.setLayout(null);
			
			jLabel8 = new JLabel();
			jLabel8.setText("Core Capital buffer:");
			jLabel8.setBounds(new Rectangle(8, 141, 116, 20));
			jLabel7 = new JLabel();
			jLabel7.setText("rnd seed:");
			jLabel7.setBounds(new Rectangle(149, 277, 65, 20));
			jLabel7.setVisible(false);
			jLabel6 = new JLabel();
			jLabel6.setText("Network topology:");
			jLabel6.setBounds(new Rectangle(8, 242, 110, 20));
			jLabel5 = new JLabel();
			jLabel5.setText("% MBS:");
			jLabel5.setBounds(new Rectangle(140, 210, 48, 21));
			jLabel5.setVisible(false);
			jLabel4 = new JLabel();
			jLabel4.setText("Experiment:");
			jLabel4.setBounds(new Rectangle(6, 180, 71, 20));
			jLabel3 = new JLabel();
			jLabel3.setText("% loss:");
			jLabel3.setBounds(new Rectangle(162, 108, 44, 20));
			jLabel3.setVisible(false);
			jLabel2 = new JLabel();
			jLabel2.setText("Trigger bank:");
			jLabel2.setBounds(new Rectangle(7, 79, 97, 20));
			jLabel1 = new JLabel();
			jLabel1.setText("Simulations parameters:");
			jLabel1.setBounds(new Rectangle(4, 28, 157, 20));
			jLabel = new JLabel();
			jLabel.setText("Dataset data:");
			jLabel.setBounds(new Rectangle(2, 2, 89, 20));
					
			jPanel_parameters.add(jLabel, null);
			jPanel_parameters.add(getJComboBox_data(), null);
			jPanel_parameters.add(getJCheckBox(), null);
			jPanel_parameters.add(jLabel7, null);
			jPanel_parameters.add(getJTextField2(), null);
			jPanel_parameters.add(getJComboBox_net(), null);
			jPanel_parameters.add(jLabel6, null);
			jPanel_parameters.add(getJTextField1(), null);
			jPanel_parameters.add(jLabel5, null);
			jPanel_parameters.add(getJComboBox_exp(), null);
			jPanel_parameters.add(jLabel4, null);
			jPanel_parameters.add(getJTextField3(), null);
			jPanel_parameters.add(jLabel8, null);
			jPanel_parameters.add(getJTextField(), null);
			jPanel_parameters.add(jLabel3, null);
			jPanel_parameters.add(getJComboBox_banks(), null);
			jPanel_parameters.add(jLabel2, null);
			jPanel_parameters.add(jLabel1, null);
		}
...
//			jPanel_contagionLeft.add(this.getTreeCollapseDemo(), null);
	...
	private JTabbedPane getJTabbedPane_leftBottom() {
		if (jTabbedPane_leftBottom == null) {
			...
			jTabbedPane_leftBottom.setBounds(new Rectangle(5, 400, 300, 148));
			jTabbedPane_leftBottom.addTab("Statistics", null, getJPanel_statistics1(), null);
			jTabbedPane_leftBottom.addTab("InDegrees", null, getJPanel_statistics2(), null);
			jTabbedPane_leftBottom.addTab("OutDegrees", null, getJPanel_statistics3(), null);
		}
	...
	private VisualizationViewer<? extends Object, ? extends Object> getGraphCDS ()
	{
		...
		return graphCDS.getGraphVisualizer(Network.getGraph(this.model.nodes, this.model.matrices.get
//				(this.model.matrices.size() - 1)), 650, 450);//1024, 768
				(this.model.matrices.size() - 1)), 1024, 768);//
	}
	...
	private VisualizationViewer<? extends Object, ? extends Object> getGraphContagion ()
	{
		...
		return graphContagion.getGraphVisualizer(this.model.contagionList, this.model.nodes, 295, 315);// The contagion Tab
...
//			jScrollPane_contagionLeft.add(this.getTreeCollapseDemo(), null);
			jScrollPane_contagionLeft.setViewportView(getJPanel_contagionLeft2());
		}
