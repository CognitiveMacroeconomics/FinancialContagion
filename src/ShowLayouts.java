...
//        topControls.add(graph_chooser);
    ...
    static JPanel getGraphPanel(Graph<? extends Object, ? extends Object> graph)
    {
        g_array = 
            (Graph<? extends Object,? extends Object>[])
            new Graph<?,?>[graph_names.length];
...
//        g_array[6] = graph;
        ...
        Graph<? extends Object, ? extends Object> g = graph; // initial graph
